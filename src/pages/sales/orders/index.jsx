...
import { OrdersUrl, languageDeleteUrl, OrdersChangeStatusUrl } from "config";
...
import { PageOrder, PreAdd, PreView, PreExport } from "config/PermissionName";
...
function Index() {
  ...
  const [sortByS, SetsortByS] = useState("order_id");
  const [orderByS, SetOrderByS] = useState("DESC");
  const [perPageItem, SetPerPageItem] = useState(10);
  const [contentloadingStatus, SetloadingStatus] = useState(true);

  const showColumn = [
    { label: Trans("SL_NO", language), field: "order_id", sort: true },
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          { title: Trans("ORDER", language), link: "", class: "active" },
        ]}
      />
      <div className="row row-xs">
        <div className="col-sm-12 col-lg-12">
          <CheckPermission PageAccess={PageOrder} PageAction={PreView}>
            <div className="card" id="custom-user-list">
              <div className="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                <h6 className="tx-uppercase tx-semibold mg-b-0">
                  {Trans("ORDER_LIST", language)}
                </h6>
                <div className="d-none d-md-flex">
                  <CheckPermission PageAccess={PageOrder} PageAction={PreAdd}>
                ...
                {contentloadingStatus ? (
                  ...
                  <div className="row">
                    <Table
                      ...
                      dataList={dataList}
                      pageName={PageOrder} // for checkpermission
                      sortBy={sortByS}
                      orderBy={orderByS}
                      filterItem={filterItem}
