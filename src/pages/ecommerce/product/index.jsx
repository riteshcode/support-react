...
import { productUrl, languageDeleteUrl, productChangeStatusUrl } from "config";
...
import { useQueryUrl } from "component/QueryUrl";
    ...
    <Content>
      ...
      <div className="row row-xs">
        <div className="col-sm-12 col-lg-12">
          <CheckPermission PageAccess={PageProducts} PageAction={PreView}>
                ...
                {contentloadingStatus ? (
                  ...
                  <div className="row">
                    <Table
                      ...
                      dataList={dataList}
                      pageName={PageProducts} // for checkpermission
                      sortBy={sortByS}
                      orderBy={orderByS}
                      filterItem={filterItem}
                      editFun={editFun}
