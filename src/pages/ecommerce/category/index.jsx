...
function Index() {
  ...
  const ChangeIsFeatureFunction = (update_id) => {
    const editData = {
      api_token: apiToken,
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          {
            title: Trans("CATEGORY", language),
            link: WebsiteLink("/categories"),
            class: catName === "" && "active",
          },
          {
            title: catName,
            link: "",
                  ...
                  <div className="row">
                    <React.Fragment>
                      <Table
                        ...
                        updateIsfeatureFunction={ChangeIsFeatureFunction}
