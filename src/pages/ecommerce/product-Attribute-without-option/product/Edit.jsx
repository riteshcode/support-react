    ...
    POST(productUpdateUrl, saveFormData)
      .then((response) => {
        ...
        if (status) {
          ...
          navigate(`/product/show/${data.product_id}`);
        } else {
          var errObj = {
            status: true,
            msg: "",
                    ...
                    <Row>
                      ...
                      <Col col={4}>
                        <FormGroup mb="20px">
                          ...
                          <select
                            ...
                            value={editInfo.product_brand_id}
                          >
                            <option value="">
                      ...
                      <Col col={6}>
                        <FormGroup mb="20px">
                          ...
                          <input
                            ...
                            defaultValue={2}
                            defaultChecked={
                              checkProductCondition === 2 ? true : false
                            }
                          />{" "}
                      ...
                      <Col col={3}>
                        <FormGroup mb="20px">
                          ...
                          <select
                            ...
                            value={editInfo.product_discount_type}
                          >
                            <option value="">
                              {Trans("SELECT_PRODUCT_TYPE", language)}
                            </option>
                      ...
                      <Col col={12}>
                        ...
                        <span className="infoInput">
                          Use Insert Keyword to Add To Tag
                        </span>
