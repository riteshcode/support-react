...
import { WebFeatureUrl, WebFeatureChangeStatusUrl, supplierDeleteUrl } from "config";
import {
  PageDepartment,
  PreAdd,
  PreView,
...
function Index() {
  ...
  const ChangeFunction = (update_id) => {
    ...
    POST(WebFeatureChangeStatusUrl, editData)
      .then((response) => {
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          { title: Trans("FEATURE", language), link: "", class: "active" },
        ]}
        heading={Trans("FEATURE_LIST", language)}
      />
      ...
      <Modal show={show} onHide={handleModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("ADD_FEATURE", language)}</Modal.Title>
      ...
      <Modal show={editModalShow} onHide={handleEditModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("UPDATE_FEATURE", language)}</Modal.Title>
