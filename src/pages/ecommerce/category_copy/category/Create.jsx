          ...
          <Col col={12}>
            <FormGroup mb="20px">
              ...
              <select
                ...
                {...register("parent_id")}
              >
                <option value={0}>{Trans("SELECT_CATEGORY", language)}</option>
                {categoryList &&
                      ...
                      <Row>
                        ...
                        <Col col={6}>
                          <FormGroup mb="20px">
                            ...
                            <MyEditor
                              setKey={`categories_description_${languages_id}`}
                              updateFun={(Key, Value) => {
                                setValue(Key, Value);
                              }}
                            />
                        ...
                        <Col col={6}>
                          <FormGroup mb="20px">
                            <TextArea
                              ...
                              className="form-control"
                              {...register(
                                `categories_menu_name_${languages_id}`
                              )}
                            />
                          </FormGroup>
                        </Col>
