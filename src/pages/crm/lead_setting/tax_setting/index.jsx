...
function Index() {
  ...
  const [sortByS, SetsortByS] = useState("tax_id");
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          {
            title: Trans("TAX", language),
            link: "",
            class: "active",
          },
        ]}
        heading={Trans("TAX", language)}
      />
      ...
      <Modal show={show} onHide={handleModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("ADD_TAX", language)}</Modal.Title>
      ...
      <Modal show={editModalShow} onHide={handleEditModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("UPDATE_TAX", language)}</Modal.Title>
