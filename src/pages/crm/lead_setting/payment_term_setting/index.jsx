...
function Index() {
  ...
  const [sortByS, SetsortByS] = useState("terms_id");
  ...
  const getUser = (pagev, perPageItemv, searchData, sortBys, OrderBy) => {
    ...
    POST(PaymentTermSettingUrl, filterData)
      .then((response) => {
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          {
            title: Trans("PAYMENT_TERM", language),
            link: "",
            class: "active",
          },
        ]}
        heading={Trans("PAYMENT_TERM", language)}
      />
      ...
      <Modal show={show} onHide={handleModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("ADD_PAYMENT_TERM", language)}</Modal.Title>
      ...
      <Modal show={editModalShow} onHide={handleEditModalClose}>
        <Modal.Header>
          <Modal.Title>{Trans("UPDATE_PAYMENT_TERM", language)}</Modal.Title>
