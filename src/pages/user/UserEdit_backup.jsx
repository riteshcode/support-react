...
function UserEdit() {
    ...
    const Imagechange = (event) => {
        console.log(event);
        if(event.target.files[0] === '' || event.target.files[0] === undefined ) return
        console.log(event.target.files[0])
        console.log(event.target.result)
        var readers = new FileReader();
        readers.onload = function (e) {
            document.querySelector("#profileimg").style.backgroundImage = `url(${e.target.result})`
        };
    ...
    const onSubmit = (formData) => {
        ...
        formData.updateId = userId;
        formData.imagePath = formData.profileimg[0];
        const fdata = new FormData(document.getElementById('edituser'))
        fdata.set("api_token", apiToken);
        fdata.set("imagePath", formData.profileimg[0]);
        fdata.set("updateId", userId);
    ...
    return (
        <Content>
            <PageHeader
                breadcumbs={[{"title":Trans("DASHBOARD", "en"),"link":"/","class":"",},{"title":Trans("EDIT_USER", "en"),"link":"","class":"active",}]}
            ...
            <div className="row row-xs">
                <div className="col-sm-3 col-md-3 col-lg-3" id="updated-info">
                    ...
                    <div className="updated-img"><img src={data.full_image_path} /></div>
                    <div className="updated-name">
                        {data.name}
                    </div>
                    ...
                    <div className="updated-social-links">
                        ...
                        <a href="#"><i className="fab fa-twitter"></i> https://twitter.com/</a>
                        <a href="#"><i className="fab fa-linkedin"></i> https://linkedin.com/</a>
                        <a href="#"><i className="fab fa-google-plus-g"></i> https://google.com/</a>
                    </div>
                ...
                {msgType.length > 2 &&
                    ...
                    <form className="edit-user-form" action="#" onSubmit={handleSubmit(onSubmit)} noValidate id="edituser">
                    ...
                    <div className="form-group"> 
                        ...
                        <label>Email</label>
                        <input type="email" id="emailid" placeholder="Enter you email id"
                            {...register("email", {
                    ...
                    <div className="form-group"> 
                        ...
                        <input type="text" id="emailid" placeholder="Enter you Contact Number"
                            {...register("contact_no", {
                    ...
                    <div className="form-group"> 
                        <div className="col-sm-3 col-md-12 col-lg">
                        <label>Title</label>
                        <input type="text" id="title" placeholder="Enter your title e.g Web Developer" 
                            {...register("title", {
                    ...
                    <div className="form-group"> 
                        <div className="col-sm-3 col-md-12 col-lg">
                            ...
                            <textarea name="user_biography" x4 id="user_biography" placeholder="Tell me about yourself !"
                                {...register("bio")}
                            ></textarea>
                        </div>
                    </div>
                    ...
                    <div className="form-group"> 
                        <div className="col-sm-3 col-md-12 col-lg">
                            <label htmlFor="autoGenerate">Auto Generate Password and send to email.
                        ...
                        {!autoGenPass && (
                            <div className="col-sm-3 col-md-12 col-lg" style={{marginTop:40}}>
