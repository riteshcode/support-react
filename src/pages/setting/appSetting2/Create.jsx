...
import { AppSettingStoreUrl, AppSettingCreateUrl } from "config/index";
...
const Create = (props) => {
  ...
  const onSubmit = (formData) => {
    ...
    POST(AppSettingStoreUrl, formData)
      .then((response) => {
      ...
      <form action="#" onSubmit={handleSubmit(onSubmit)} noValidate>
        <Row>
          ...
          <Col col={12}>
            <FormGroup mb="20px">
              <Input
                id={Trans("SETTING_OPTION", language)}
                label={Trans("SETTING_OPTION", language)}
                placeholder="For Multiple (ABC,BCD) use comma seperate"
                className="form-control"
          ...
          <Col col={12}>
            <FormGroup mb="20px">
              <Input
                id={Trans("OPTION_TYPE", language)}
                label={Trans("OPTION_TYPE", language)}
                placeholder="For Multiple (ABC,BCD) use comma seperate"
                className="form-control"
              ...
              />
              <span className="required">
                <ErrorMessage errors={errors} name="setting_type" />
              </span>
            </FormGroup>
          </Col>
          <Col col={12}>
