          ...
          <table className="table">
            <thead>
              <tr>
                ...
                <th>{Trans("PAGE_NAME", language)}</th>
                <th>{Trans("PAGE_SLUG", language)}</th>
