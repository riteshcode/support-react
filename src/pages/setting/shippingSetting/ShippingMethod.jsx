...
import ShippingMethodKey from "./ShippingMethodKey";
import { Alert, Tab, Tabs } from "react-bootstrap";
import { useForm, FormProvider } from "react-hook-form";
import { ErrorMessage } from "@hookform/error-message";
import { shippingUpdateUrl } from "config";
import { Trans } from "lang/index";

function ShippingMethod({ fieldKey }) {
  ...
  const onSubmit = (formData) => {
    ...
    POST(shippingUpdateUrl, formData)
      .then((response) => {
              ...
              <FormProvider {...methods}>
                <form action="#" onSubmit={handleSubmit(onSubmit)} noValidate>
                  <Row>
                    <Col col={12}>
                      <ShippingMethodKey
                        fieldKey={item.shiping_methods_details}
                        currKey={item.method_id}
                      />
                    </Col>
                  </Row>
