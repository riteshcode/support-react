...
import { shippingMethodListUrl, shippingUpdateUrl } from "config";
...
function AppSetting() {
  ...
  const loadSettingData = () => {
    ...
    POST(shippingMethodListUrl, filterData)
      .then((response) => {
                ...
                <CheckPermission IsPageAccess="role.view">
                  <div className="card" id="custom-user-list">
                    ...
                    <div className="card-body">
                      <ShippingMethod fieldKey={listData} />
                    </div>
                  </div>
                </CheckPermission>
              </div>
