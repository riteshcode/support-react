  ...
  return (
    <>
      ...
      <nav className="nav nav-classNameic">
        <Anchor
          path={WebsiteLink("/setting/application/application")}
          className={
        ...
        <Anchor
          path={WebsiteLink("/setting/application/business")}
          className={
        ...
        <Anchor
          path={WebsiteLink("/setting/application/email")}
          className={activeClass === "email" ? "nav-link active" : "nav-link"}
        >
          {Trans("EMAIL_SETTING", language)}
        </Anchor>
        <Anchor
          path={WebsiteLink("/setting/application/sms")}
          className={activeClass === "sms" ? "nav-link active" : "nav-link"}
        >
          {Trans("SMS_SETTING", language)}
        </Anchor>
        <Anchor
          path={WebsiteLink("/setting/application/notification")}
          className={
            activeClass === "notification" ? "nav-link active" : "nav-link"
          }
        >
          {Trans("NOTIFICATION_SETTING", language)}
        </Anchor>
      </nav>
    </>
  );
