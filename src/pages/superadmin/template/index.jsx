...
import AddTemplateGroup from "./AddTemplateGroup";
...
function Index() {
  ...
  const handleSubGroupModuleModaLClose = () => SetSubAddGroupModuleShow(false);
  const handleSubGroupModuleModalShow = () => SetSubAddGroupModuleShow(true);
    ...
    <Content>
      <PageHeader
        breadcumbs={[
          ...
          { title: Trans("TEMPLATE", language), link: "", class: "active" },
        ]}
      />
            ...
            <div className="card" id="custom-user-list">
              <div className="card-header pd-y-15 pd-x-20 d-flex align-items-center justify-content-between">
                <h6 className="tx-uppercase tx-semibold mg-b-0">
                  {Trans("TEMPLATE_MANAGEMENT", language)}
                </h6>
                <div className="d-none d-md-flex">
                  ...
                  <CheckPermission PageAccess={PageModule} PageAction={PreAdd}>
                    <Button
                      variant="primary"
                      onClick={handleSubGroupModuleModalShow}
                    >
                      <FeatherIcon
                        icon="plus"
                        fill="white"
                        className="wd-10 mg-r-5"
                      />
                      {Trans("ADD_TEMPLATE_GROUP", language)}
                    </Button>
                  </CheckPermission> */}
                  &nbsp;
                  <CheckPermission PageAccess={PageModule} PageAction={PreAdd}>
                    ...
                    >
                      <FeatherIcon
                        ...
                        className="wd-10 mg-r-5"
                      />
                      {Trans("ADD_TEMPLATE_SECTION", language)}
                    </Button>
                  </CheckPermission>
                  &nbsp;
                  <CheckPermission PageAccess={PageModule} PageAction={PreAdd}>
      ...
      <Modal show={addSubModuleShow} onHide={handleSubModuleModalClose}>
        <Modal.Header>
          <Modal.Title>
            {Trans("ADD_TEMPLATE_SECTION_OPTIONS", language)}
          </Modal.Title>
      ...
      <Modal
        ...
        onHide={handleSubGroupModuleModaLClose}
      >
        <Modal.Header>
          <Modal.Title>{Trans("ADD_SECTION_GROUP", language)}</Modal.Title>
          <Button variant="danger" onClick={handleSubGroupModuleModaLClose}>
            X
          </Button>
        </Modal.Header>
        <Modal.Body>
          <AddTemplateGroup
            filterItem={filterItem}
            handleModalClose={handleSubGroupModuleModaLClose}
          />
        </Modal.Body>
      </Modal>
      {/* end end modal */}
