        ...
        <Row>
          ...
          <Col col={12}>
            <FormGroup mb="20px">
              <Input
                type="hidden"
                id={Trans("INDUSTRY_TYPE", language)}
                label={Trans("INDUSTRY_TYPE", language)}
                placeholder={Trans("INDUSTRY_TYPE", language)}
                className="form-control"
                {...register("industry_id", {
                  required: Trans("INDUSTRY_TYPE_REQUIRED", language),
                })}
              />
